...
public class FXMLDocumentController implements Initializable {
    ...
    private void high() {
        if (this.audioPlayer == null) return;
        Slider0.setValue(-80);
        audioPlayer.getEqualizer().getFilter((short)0).setGain((float) Math.pow(10,-200/20));
        Slider1.setValue(-80);
        audioPlayer.getEqualizer().getFilter((short)1).setGain((float) Math.pow(10,-200/20));
        Slider2.setValue(-80);
        audioPlayer.getEqualizer().getFilter((short)2).setGain((float) Math.pow(10,-200/20));
        Slider3.setValue(-80);
        audioPlayer.getEqualizer().getFilter((short)3).setGain((float) Math.pow(10,-200/20));
        Slider4.setValue(-80);
        audioPlayer.getEqualizer().getFilter((short)4).setGain((float) Math.pow(10,-200/20));
        Slider5.setValue(-80);
        audioPlayer.getEqualizer().getFilter((short)5).setGain((float) Math.pow(10,-200/20));
        Slider6.setValue(-80);
        audioPlayer.getEqualizer().getFilter((short)6).setGain((float) Math.pow(10,-200/20));
        Slider7.setValue(-80);
        audioPlayer.getEqualizer().getFilter((short)7).setGain((float) Math.pow(10,-200/20));
        Slider8.setValue(-80);
        audioPlayer.getEqualizer().getFilter((short)8).setGain((float) Math.pow(10,-200/20));
        Slider9.setValue(0);
    }
    @FXML
    ...
    private void listenSliders(){
        Slider0.valueProperty().addListener((observable, oldValue, newValue) -> {
            audioPlayer.getEqualizer().getFilter((short)0).setGain((float) Math.pow(10,newValue.doubleValue()/20));
        });

        Slider1.valueProperty().addListener((observable, oldValue, newValue) -> {
            audioPlayer.getEqualizer().getFilter((short)1).setGain((float) Math.pow(10,newValue.doubleValue()/20));
        });

        Slider2.valueProperty().addListener((observable, oldValue, newValue) -> {
            audioPlayer.getEqualizer().getFilter((short)2).setGain((float) Math.pow(10,newValue.doubleValue()/20));
        });

        Slider3.valueProperty().addListener((observable, oldValue, newValue) -> {
            audioPlayer.getEqualizer().getFilter((short)3).setGain((float) Math.pow(10,newValue.doubleValue()/20));
        });

        Slider4.valueProperty().addListener((observable, oldValue, newValue) -> {
            audioPlayer.getEqualizer().getFilter((short)4).setGain((float) Math.pow(10,newValue.doubleValue()/20));
        });

        Slider5.valueProperty().addListener((observable, oldValue, newValue) -> {
            audioPlayer.getEqualizer().getFilter((short)5).setGain((float) Math.pow(10,newValue.doubleValue()/20));
        });

        Slider6.valueProperty().addListener((observable, oldValue, newValue) -> {
            audioPlayer.getEqualizer().getFilter((short)6).setGain((float) Math.pow(10,newValue.doubleValue()/20));
        });

        Slider7.valueProperty().addListener((observable, oldValue, newValue) -> {
            audioPlayer.getEqualizer().getFilter((short)7).setGain((float) Math.pow(10,newValue.doubleValue()/20));
        });

        Slider8.valueProperty().addListener((observable, oldValue, newValue) -> {
            audioPlayer.getEqualizer().getFilter((short)8).setGain((float) Math.pow(10,newValue.doubleValue()/20));
        });

        Slider9.valueProperty().addListener((observable, oldValue, newValue) -> {
            audioPlayer.getEqualizer().getFilter((short)9).setGain((float) Math.pow(10,newValue.doubleValue()/20));
        });
